...
public class KnobStyleKit: NSObject {
    ...
    @objc dynamic public class func drawKnobOne(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 124, height: 124), resizing: ResizingBehavior = .aspectFit, knobValue: CGFloat = 0.5) {
        ...
        //// Color Declarations
        let black = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 0.000)
        let shadowColor = UIColor(red: 0.00, green: 0.00, blue: 0.000, alpha: 1.000)
        let knobBottom = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 0.800)
        let knobLight = UIColor(red: 1.000, green: 1.000, blue: 1.000, alpha: 0.400)
        let knobTop2 = UIColor(red: 0.000, green: 0.000, blue: 0.000, alpha: 0.200)
        let orange2 = UIColor(red: 0.45, green: 0.83, blue: 1.000, alpha: 1.000)

        //// Gradient Declarations
        let edge2 = CGGradient(colorsSpace: nil, colors: [knobBottom.cgColor, knobBottom.blended(withFraction: 0.9, of: knobTop2).cgColor, knobTop2.cgColor, knobTop2.blended(withFraction: 0.6, of: knobLight).cgColor, knobLight.cgColor] as CFArray, locations: [0, 0.23, 0.70, 0.90, 1])!
        let lowerKnobGradient2 = CGGradient(colorsSpace: nil, colors: [knobTop2.cgColor, knobBottom.cgColor, knobLight.cgColor] as CFArray, locations: [0, 1, 1])!

        //// Shadow Declarations
        let shadow2 = NSShadow()
        shadow2.shadowColor = UIColor.black.withAlphaComponent(0.40)
        shadow2.shadowOffset = CGSize(width: 2, height: 8)
        shadow2.shadowBlurRadius = 8
        let shadow3 = NSShadow()
        shadow3.shadowColor = knobLight.withAlphaComponent(0.00 * knobLight.cgColor.alpha)
